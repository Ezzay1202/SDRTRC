...
for pred_len in 96 720; do
  ...
  python -u run_longExp.py \
    ...
    --hsd_zero_init 1 \
    --hsd_rng_safe_init 1 \
    --hsd_residual_scale 0.03 \
    --hsd_aux_lambda 0.01 \
    --hsd_risk_use_quantile 1 \
    --hsd_risk_quantile 0.75 \
    ...
    --itr 1 \
    --batch_size 128 \
    --learning_rate 0.0005 | tee logs/LongForecasting/ETTh1/${model_name}_${model_id_name}_${pred_len}_v2_safe.log
